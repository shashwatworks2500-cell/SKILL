...
> **Note:** four skills are authored (`scribeo-ux-engineering`, `scribeo-motion`, `scribeo-visual-qa`, `scribeo-performance`); the remaining three are scaffolding. See [Status](#status).
...
| `scribeo-accessibility` | Not started |
